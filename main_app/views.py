...
def cats_index(request):
    ...
    # we pass datat to our templates through our view functions
    # we can gather relations from SQL using our models methods
...
class CatUpdate(UpdateView):
    model = Cat
    # let's use custom fields to diallow renaming the cat
...
def add_feeding(request, cat_id):
    ...
    if form.is_valid():
        # we dont want to save the form to the db until it has the cat id
...
class ToyCreate(CreateView):
    ...
    # define what the inherited method is_valid does(we'll udpate this later)
